...
<div class="space-y-6">
    ...
    <div class="text-center">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900">Join Us Today</h2>
        <p class="mt-2 text-gray-600">Enter your email and password to register.</p>
    </div>
            ...
            <div>
                ...
                <div class="relative">
                    <input 
                        ...
                        class="block w-full rounded-lg border px-4 py-3 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200 {{ $errors->has('first_name') ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500' }}"
                    >
            ...
            <div>
                ...
                <div class="relative">
                    <input 
                        ...
                        value="{{ old('last_name') }}"
                        class="block w-full rounded-lg border px-4 py-3 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200 {{ $errors->has('last_name') ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500' }}"
                    >
        ...
        <div>
            ...
            <div class="relative">
                <input 
                    ...
                    class="block w-full rounded-lg border px-4 py-3 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200 {{ $errors->has('date_of_birth') ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500' }}"
                >
        ...
        <div>
            ...
            <div class="relative">
                <input 
                    ...
                    class="block w-full rounded-lg border px-4 py-3 pr-12 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200 {{ $errors->has('password_confirmation') ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500' }}"
                >
                <button 
                    type="button" 
                    ...
                    class="absolute inset-y-0 right-0 flex items-center pr-3"
                >
                    <span class="material-icons text-gray-400 hover:text-gray-600 transition-colors" id="password_confirmation-toggle-icon">visibility</span>
                </button>
            </div>
